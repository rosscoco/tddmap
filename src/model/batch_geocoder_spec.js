        ...
        describe("Is Successful if...", function() {
            describe("On receiving a status of OK...", function() {
                beforeEach(function() {
                    ...
                    batchGeocoder = new BatchGeocoder(
                        "CM1 4QS",
                        geocoder,
                        function() {}
                    );
                ...
                it("should async call onGeocodeResponse with the found location", function(
                    done
                ) {
                    batchGeocoder = new BatchGeocoder(
                        "CM1 4QS",
                    ...
                    sinon
                        ...
                        .yieldsAsync(helpers.singleValidGeocodeResponse, "OK");
                ...
                it("should add the location to the success array if a single valid location is returned", function(
                    ...
                    var onComplete = function() {
                        var calledWith = batchGeocoder.onLocationParsed.getCall(
                            0
                        ).args[1];

                        assert.deepEqual(
                            calledWith,
                            helpers.parsedValidResponse
                        );
                    ...
                    sinon
                        .stub(geocoder, "geocode")
                        .yields(helpers.singleValidGeocodeResponse, "OK");
            ...
            it("does not receive a response for every provided location", function(
                ...
                batchGeocoder = new BatchGeocoder(
                    ...
                    function() {
                        ...
                        assert(
                            batchGeocoder.onGeocodeResponse.callCount === 10
                        );
                        done();
                    }
                );
        ...
        describe("Error handling...", function() {
            ...
            describe("Should handle rate limited responses", function() {
                ...
                beforeEach(function() {
                    ...
                    settings = {
                        geocodeInterval: delay,
                        rateIncrease: rateIncrease
                    };
                });

                it("delays the next if OVER_QUERY_LIMIT received", function(
                    done
                ) {
                    ...
                    function onComplete(status, results) {
                        ...
                        assert(
                            ...
                            "Should delay after request limit reached before geocoding next item"
                        );
                        done();
                    }
                ...
                it("increments the geocode interval for each subsequent OVER_QUERY_LIMIT received", function(
                    done
                ) {
                    stub
                        .onCall(0)
